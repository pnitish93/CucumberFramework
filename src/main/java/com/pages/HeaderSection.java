...
public class HeaderSection {
	...
	public ResultPage enterTextAndSearchFor(String searchItem) {
	...
	public void checkIfSearchCategoryIsClickable() {
		utils.checkIfElementIsClickable(searchCategory);
	}

	public void selectValueFromSearchCategory(String categoryValue) {
		utils.selectValueFromDropdownByVisibleText(searchCategory, categoryValue);
	}
